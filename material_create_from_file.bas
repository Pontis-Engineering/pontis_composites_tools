...
Debug.Print(ExcelWorksheet.Name)
    ...
    '===================TO CHECK THE DATA ONLY ==================================
    For i = LBound(ExcelDataArray, 1) To UBound(ExcelDataArray, 1)
        For j = LBound(ExcelDataArray, 2) To UBound(ExcelDataArray, 2)
            Debug.Print ExcelDataArray(i, j)
        Next j
    Next i
	    '=====================================================================
End Function
